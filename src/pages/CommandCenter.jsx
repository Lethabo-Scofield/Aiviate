    ...
    <div className="animate-fade-in max-w-3xl">
      ...
      <div className="mb-6 flex items-start justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-[14px] text-[#868E96] mt-1">
            The decisions that need your attention right now, based on live driver and safety data.
          </p>
        </div>
        <div className="flex flex-col items-end">
          <span
            className="text-[22px] font-semibold px-4 py-1 rounded-full leading-none"
            style={{ background: visibleRecs.length > 0 ? "#ff3b30" : "#34c759", color: "white" }}
          >
            {visibleRecs.length}
          </span>
          <span className="text-[11px] text-[#ADB5BD] uppercase tracking-wider font-semibold mt-1.5">
      ...
      {loadError && !lastSyncAt ? (
        ...
        recs.length === 0 ? (
          ...
          <div className="apple-card p-10 text-center">
            ...
            <p className="text-[13px] text-[#868E96] mt-1">
              The underlying risks may still be active. Acknowledging only hides the card.
            </p>
            <button
      ...
      <div className="mt-8">
        <div className="flex items-center gap-2 mb-3">
          <span className="text-[11px] uppercase tracking-wider font-semibold text-[#868E96]">
            Running automatically
          </span>
              ...
              <div key={e.id} className="px-5 py-3 flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[11px] text-[#868E96] mt-0.5">
                    {e.actor === "workflow_engine" ? "Automatic" : "You"} · {timeAgo(e.at)}
                  </p>
                </div>
              </div>
            ))}
