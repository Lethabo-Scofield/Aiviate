  ...
  return (
    <div className="apple-card p-4 sm:p-5 flex items-start gap-3 sm:gap-4">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-[14px] font-semibold text-[#111315] leading-snug">{rec.what}</p>
        {rec.why && <p className="text-[12px] text-[#868E96] mt-1 leading-snug">{rec.why}</p>}
        <p className="text-[12px] text-[#111315] mt-2 flex items-start gap-1.5">
          <Zap size={12} className="text-[#008080] mt-0.5 shrink-0" />
          <span>
            <span className="text-[#868E96]">Recommended: </span>
            {rec.action}
          </span>
        </p>
        {rec.expected_benefit && (
          <p className="text-[11px] text-[#868E96] mt-1 italic">→ {rec.expected_benefit}</p>
        )}
        <div className="mt-3 flex items-center gap-2">
          ...
          <button
            ...
            className="text-[12px] text-[#ADB5BD] hover:text-[#868E96] ml-auto px-2 py-1"
          >
  ...
  return (
    <div className="animate-fade-in">
      <div className="mb-5 sm:mb-6 flex items-start justify-between gap-4 flex-wrap">
        <div>
          <h1 className="text-[24px] sm:text-[28px] font-semibold text-[#111315] tracking-tight flex items-center gap-2">
        ...
        <div className="flex items-center gap-2">
          <span className="text-[11px] text-[#ADB5BD] uppercase tracking-wider font-semibold">Decisions waiting</span>
          <span
      ...
      <div className="apple-card p-5 mb-5 border border-[#008080]/15 bg-gradient-to-br from-[#008080]/[0.04] to-transparent">
        <div className="flex items-start gap-3 mb-3">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2">
              <p className="text-[14px] font-semibold text-[#111315]">Aiviate Auto-pilot</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-3">
          <div className="text-[12px] text-[#111315] flex items-start gap-2">
        ...
        {autoActions.length > 0 && (
          <div className="pt-3 border-t border-[#008080]/10">
            <p className="text-[10px] uppercase tracking-wider text-[#868E96] font-semibold mb-1.5">
              Latest auto-pilot action
            </p>
            <p className="text-[12px] text-[#111315]">
              {autoActions[0].summary}{" "}
              <span className="text-[#ADB5BD]">· {timeAgo(autoActions[0].at)}</span>
            </p>
          </div>
        )}
      </div>
      ...
      {loadError && !lastSyncAt ? (
        ...
        recs.length === 0 ? (
          <div className="apple-card p-10 text-center">
            ...
            <p className="text-[16px] font-semibold text-[#111315]">No risks detected</p>
            <p className="text-[13px] text-[#868E96] mt-1">
          ...
          <div className="apple-card p-10 text-center">
            ...
            <p className="text-[16px] font-semibold text-[#111315]">All {recs.length} acknowledged this session</p>
            <p className="text-[13px] text-[#868E96] mt-1">
      ...
      {/* Handled — audit log */}
      <div className="mt-8">
        <div className="flex items-center gap-2 mb-3 text-[11px] uppercase tracking-wider font-semibold text-[#868E96]">
          <History size={12} />
          Recently handled
        </div>
